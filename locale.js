(() => {
  ...
  const dictionaries = {
    zh: {
      ...
      "order.menuTitle": "选酒",
      "order.menuIntro": "每杯都装订成一张可滑动酒卡：海报、酒名、真实诗句、出处与原料都在同一张纸上。点击“加入”增加一杯。",
      ...
      "order.more": "再展开",
      "order.swipeHint": "左右滑动翻酒单",
      "order.previousCard": "上一张酒卡",
      "order.nextCard": "下一张酒卡",
      "order.carouselLabel": "横向滑动酒单",
      "order.quoteSource": "核对原作",
    ...
    en: {
      ...
      "order.menuIntro": "Each drink is bound as a swipeable card, with its poster, name, verified verse, source, and ingredients on one sheet. Each press of Add adds one glass.",
      ...
      "order.swipeHint": "Swipe through the cards",
      "order.previousCard": "Previous drink card",
      "order.nextCard": "Next drink card",
      "order.carouselLabel": "Horizontally scrolling drinks menu",
      "order.quoteSource": "Verify the poem",
