...
每款酒都匹配一条已出版且可追溯的公版诗句，数据记录在 `data/order-quotes.json`。当前引文库包含中文、英语、法语、西班牙语、意大利语和葡萄牙语原文；每条都有作者、作品、来源页、公版依据与核验日期。非中文原文会附本站编辑中文翻译；英文界面中的中文原诗会附本站编辑英文翻译。相近风格的酒可以共享同一句真实诗，真实性和配方契合度优先于人为制造的唯一性。
